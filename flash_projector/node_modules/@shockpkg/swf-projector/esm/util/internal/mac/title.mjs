...
import { findFuzzyOnce } from "../patch.mjs";
import { TITLE_ARM64, TITLE_I386, TITLE_X8664 } from "./asm.mjs";
import { CPU_TYPE_ARM64, CPU_TYPE_I386, CPU_TYPE_X86_64 } from "./constants.mjs";

/**
 * MacProjectTitlePatch object.
 */
export class MacProjectTitlePatch {
  /**
 ...
 */
export class MacProjectTitlePatchI386 extends MacProjectTitlePatch {
  static CPU_TYPE = CPU_TYPE_I386;
}

/**
 * MacProjectTitlePatchX8664 object.
 */
export class MacProjectTitlePatchX8664 extends MacProjectTitlePatch {
  static CPU_TYPE = CPU_TYPE_X86_64;
}

/**
 * MacProjectTitlePatchARM64 object.
 */
export class MacProjectTitlePatchARM64 extends MacProjectTitlePatch {
  static CPU_TYPE = CPU_TYPE_ARM64;
}
...
class extends MacProjectTitlePatchX8664 {
  ...
  check() {
    ...
    if (findFuzzyOnce(this._data.subarray(offsetJump, offsetJump + 7), TITLE_X8664['11-2']) !== 0) {
      return false;
    }
    this._offset_ = found;
 ...
 */
export function macProjectorTitlePatchesByCpuType(cpuType) {
  if (!byCpuType) {
    byCpuType = new Map();
