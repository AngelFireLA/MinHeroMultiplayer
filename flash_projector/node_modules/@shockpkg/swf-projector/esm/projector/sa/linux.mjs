...
import { linuxProjectorPatch } from "../../util/linux.mjs";
import { EM_X86_64 } from "../../util/internal/linux/elf.mjs";
...
export class ProjectorSaLinux extends ProjectorSa {
  ...
  async _writePlayer(player) {
    ...
    if (isElf) {
      ...
      archive = isDir ? new ArchiveDir(player) : createArchiveByFileExtensionOrThrow(player, {
  ...
  async _getPatchBinary() {
    ...
    const patch = {
       ...
       * @inheritdoc
       */
      modify: data => linuxProjectorPatch(data, {
        patchWindowTitle,
        patchMenuRemove,
        patchProjectorPath,
        patchProjectorOffset
  ...
  async _getPatchMovie() {
    ...
    const patch = {
      ...
      modify: data => {
        ...
        return concat([data, this._encodeMovieData(movieData, v.getUint16(18, true) === EM_X86_64 ? 'lid' : 'smd')]);
      },
      /**
       * @inheritdoc
       */
