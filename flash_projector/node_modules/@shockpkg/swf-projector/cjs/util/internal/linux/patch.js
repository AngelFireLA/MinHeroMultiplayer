...
class Patch {
  ...
  *_findFuzzyCode(find) {
    ...
    for (const i of (0, _patch.findFuzzy)(d, find)) {
      yield [shdr, i, d];
    }
  }
   ...
   */
  _findEbx(addr) {
    if (this._elf.bits !== 32 || this._elf.elfHeader.eMachine !== _elf.EM_386) {
    ...
    for (const i of (0, _patch.findFuzzy)(d, _asm.PATCH_I386['ebx'], 0, before, true)) {
