...
exports.SHT_SYMTAB = exports.SHT_SUNW_VERSYM = exports.SHT_SUNW_VERNEED = exports.SHT_SUNW_VERDEF = exports.SHT_SUNW_SYMINFO = exports.SHT_SUNW_MOVE = exports.SHT_SUNW_COMDAT = exports.SHT_STRTAB = exports.SHT_SHLIB = exports.SHT_RELA = exports.SHT_REL = exports.SHT_PROGBITS = exports.SHT_NULL = exports.SHT_NOTE = exports.SHT_NOBITS = exports.SHT_LOUSER = exports.SHT_LOPROC = exports.SHT_HIUSER = exports.SHT_HIPROC = exports.SHT_HASH = exports.SHT_DYNSYM = exports.SHT_DYNAMIC = exports.SHF_WRITE = exports.SHF_MASKPROC = exports.SHF_EXECINSTR = exports.SHF_ALLOC = exports.PT_SUNWSTACK = exports.PT_SUNWBSS = exports.PT_SHLIB = exports.PT_PHDR = exports.PT_NULL = exports.PT_NOTE = exports.PT_LOSUNW = exports.PT_LOPROC = exports.PT_LOAD = exports.PT_INTERP = exports.PT_HISUNW = exports.PT_HIPROC = exports.PT_DYNAMIC = exports.PF_WRITE_EXEC = exports.PF_WRITE = exports.PF_READ_WRITE_EXEC = exports.PF_READ_WRITE = exports.PF_READ_EXEC = exports.PF_READ = exports.PF_NONE = exports.PF_EXEC = exports.Elf64Shdr = exports.Elf64Phdr = exports.Elf64Ehdr = exports.Elf64 = exports.Elf32Shdr = exports.Elf32Phdr = exports.Elf32Ehdr = exports.Elf32 = exports.EM_X86_64 = exports.EM_386 = exports.ELFDATA2MSB = exports.ELFDATA2LSB = exports.ELFCLASS64 = exports.ELFCLASS32 = exports.EIdent = void 0;
exports.decode = decode;
var _data = require("../data.js");
/* eslint-disable max-classes-per-file */

const ELFCLASS32 = exports.ELFCLASS32 = 1;
const ELFCLASS64 = exports.ELFCLASS64 = 2;
const ELFDATA2LSB = exports.ELFDATA2LSB = 1;
const ELFDATA2MSB = exports.ELFDATA2MSB = 2;
const EM_386 = exports.EM_386 = 3;
const EM_X86_64 = exports.EM_X86_64 = 62;
const PT_NULL = exports.PT_NULL = 0;
const PT_LOAD = exports.PT_LOAD = 1;
const PT_DYNAMIC = exports.PT_DYNAMIC = 2;
const PT_INTERP = exports.PT_INTERP = 3;
const PT_NOTE = exports.PT_NOTE = 4;
const PT_SHLIB = exports.PT_SHLIB = 5;
const PT_PHDR = exports.PT_PHDR = 6;
const PT_LOSUNW = exports.PT_LOSUNW = 0x6ffffffa;
const PT_SUNWBSS = exports.PT_SUNWBSS = 0x6ffffffb;
const PT_SUNWSTACK = exports.PT_SUNWSTACK = 0x6ffffffa;
const PT_HISUNW = exports.PT_HISUNW = 0x6fffffff;
const PT_LOPROC = exports.PT_LOPROC = 0x70000000;
const PT_HIPROC = exports.PT_HIPROC = 0x7fffffff;
const PF_NONE = exports.PF_NONE = 0x0;
const PF_EXEC = exports.PF_EXEC = 0x1;
const PF_WRITE = exports.PF_WRITE = 0x2;
const PF_WRITE_EXEC = exports.PF_WRITE_EXEC = 0x3;
const PF_READ = exports.PF_READ = 0x4;
const PF_READ_EXEC = exports.PF_READ_EXEC = 0x5;
const PF_READ_WRITE = exports.PF_READ_WRITE = 0x6;
const PF_READ_WRITE_EXEC = exports.PF_READ_WRITE_EXEC = 0x7;
const SHT_NULL = exports.SHT_NULL = 0;
const SHT_PROGBITS = exports.SHT_PROGBITS = 1;
const SHT_SYMTAB = exports.SHT_SYMTAB = 2;
const SHT_STRTAB = exports.SHT_STRTAB = 3;
const SHT_RELA = exports.SHT_RELA = 4;
const SHT_HASH = exports.SHT_HASH = 5;
const SHT_DYNAMIC = exports.SHT_DYNAMIC = 6;
const SHT_NOTE = exports.SHT_NOTE = 7;
const SHT_NOBITS = exports.SHT_NOBITS = 8;
const SHT_REL = exports.SHT_REL = 9;
const SHT_SHLIB = exports.SHT_SHLIB = 10;
const SHT_DYNSYM = exports.SHT_DYNSYM = 11;
const SHT_SUNW_MOVE = exports.SHT_SUNW_MOVE = 0x6ffffffa;
const SHT_SUNW_COMDAT = exports.SHT_SUNW_COMDAT = 0x6ffffffb;
const SHT_SUNW_SYMINFO = exports.SHT_SUNW_SYMINFO = 0x6ffffffc;
const SHT_SUNW_VERDEF = exports.SHT_SUNW_VERDEF = 0x6ffffffd;
const SHT_SUNW_VERNEED = exports.SHT_SUNW_VERNEED = 0x6ffffffe;
const SHT_SUNW_VERSYM = exports.SHT_SUNW_VERSYM = 0x6fffffff;
const SHT_LOPROC = exports.SHT_LOPROC = 0x70000000;
const SHT_HIPROC = exports.SHT_HIPROC = 0x7fffffff;
const SHT_LOUSER = exports.SHT_LOUSER = 0x80000000;
const SHT_HIUSER = exports.SHT_HIUSER = 0xffffffff;
const SHF_WRITE = exports.SHF_WRITE = 0x1;
const SHF_ALLOC = exports.SHF_ALLOC = 0x2;
const SHF_EXECINSTR = exports.SHF_EXECINSTR = 0x4;
const SHF_MASKPROC = exports.SHF_MASKPROC = 0xf0000000;
...
class Elf32 {
  ...
  decode(data, offset = 0) {
    ...
    for (let i = 0; i < elfHeader.eShnum; i++) {
      ...
      if (fileSize) {
        s.data = (0, _data.getBuffer)(data, offset + s.shOffset, fileSize);
      }
    }
  }
  ...
  encode(data, offset = 0) {
    ...
    for (let i = 0; i < elfHeader.eShnum; i++) {
      ...
      if (fileSize) {
        (0, _data.setBuffer)(data, offset + s.shOffset, s.data, fileSize);
      }
    }
  }
...
class Elf64 {
  ...
  decode(data, offset = 0) {
    ...
    for (let i = 0; i < elfHeader.eShnum; i++) {
      ...
      if (fileSize) {
        s.data = (0, _data.getBuffer)(data, offset + Number(s.shOffset), Number(fileSize));
      }
    }
  }
  ...
  encode(data, offset = 0) {
    ...
    for (let i = 0; i < elfHeader.eShnum; i++) {
      ...
      if (fileSize) {
        (0, _data.setBuffer)(data, offset + Number(s.shOffset), s.data, Number(fileSize));
      }
    }
  }
