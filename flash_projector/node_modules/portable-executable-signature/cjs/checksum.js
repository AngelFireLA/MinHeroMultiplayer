 ...
 */
function checksumSet(data, value) {
  const view = (0, _util.dataAsDataView)(data);
 ...
 */
function checksumUpdate(data, preserveNull) {
  const view = (0, _util.dataAsDataView)(data);
