import { dataAsDataViewReadonly } from "./util.mjs";
import { checksumUpdate } from "./checksum.mjs";
 ...
 */
export function signatureGet(data) {
 ...
 * @returns Updated PE.
 */
export function signatureSet(data, signature, updateChecksum = true, preserveNullChecksum = false) {
  const view = dataAsDataViewReadonly(data);
